""" 
    This module creates otp and verifies otp.
...
class TOTPVerification:
    ...
    def __init__(self, instance=None):
        ...
        if instance is not None:
            self.key = random_hex(len(instance.email))
        else:
        ...
        self.number_of_digits = settings.NUMBER_OF_OTP_DIGITS
        # validity period of a token. Default is 30 second.
        self.token_validity_period = settings.TOKEN_VALIDITY_PERIOD
